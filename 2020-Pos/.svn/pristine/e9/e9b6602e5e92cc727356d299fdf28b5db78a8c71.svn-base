...
class OnlineOrderDetailParentAdapter(mContext: Context, itemList: ArrayList<OrderProduct>, layoutId: Int=R.layout.item_order_detail_parent) :
    ...
    override fun bindData(holder: ViewHolder, data: OrderProduct, position: Int) {
        ...
        val goodsInfo= arrayListOf(data.goodsName,data.productCount.toString(),data.productSn,data.salePrice.toString().ext_formatAmountWithUnit(),data.goodsSpecifitionNameValue,data.totalPrice.ext_formatAmountWithUnit())
