        ...
        if (mSharedPreferences == null || instance == null) {
            synchronized (SPDownloadUtil.class) {
                if (mSharedPreferences == null || instance == null) {
                    ...
                    mSharedPreferences = AppContext.getInstance().getContext().getSharedPreferences(AppContext.getInstance().getContext().getPackageName() + ".downloadSp", Context.MODE_PRIVATE);
