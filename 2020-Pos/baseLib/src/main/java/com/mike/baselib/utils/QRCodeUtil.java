...
public class QRCodeUtil {
     ...
     */
    private static boolean createQRImage(String content, int widthPix, int heightPix,
    ...
    public static String getQrImagePath(Context context,String content,int width,int height,Bitmap logo){
        String filePath=getFileRoot(context) + File.separator
                + "qr_" + System.currentTimeMillis() + ".jpg";
        if(createQRImage(content,width,height,logo,filePath)){
            return filePath;
        }
        return "";
