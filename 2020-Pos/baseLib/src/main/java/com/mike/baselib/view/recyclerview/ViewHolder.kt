...
class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
    ...
    fun setViewVisible(viewId: Int): ViewHolder {
        return setViewVisibility(viewId, View.VISIBLE)
    }

    fun setViewGone(viewId: Int): ViewHolder {
        return setViewVisibility(viewId, View.GONE)
    }

    fun setViewInvisible(viewId: Int): ViewHolder {
        return setViewVisibility(viewId, View.INVISIBLE)
    }
